...
public class CustomSourceFaultToleranceTopologyChangedTest {

    private static boolean jobRestarted;

    private final Set<JetInstance> instances
            = Collections.newSetFromMap(new ConcurrentHashMap<>());

    @After
    public void tearDown() {
        for (JetInstance jet : instances) {
    ...
    public void testRestartJobWhenNodeWasRemoved() {
        testTopologyChange(() -> newJetInstance(new JetConfig()), node -> node.shutdown());
    }

    @Test
    public void testRestartJobWhenNodeWasAdded() {
        testTopologyChange(() -> null, ignore -> newJetInstance(new JetConfig()));
    }
    ...
    private void testTopologyChange(Supplier<JetInstance> initializeSecondMember, Consumer<JetInstance> changeTopology) {
        ...
        JetInstance jet = newJetInstance(new JetConfig());
    ...
    private JetInstance newJetInstance(JetConfig config) {
